...
ALTER TABLE assets ADD COLUMN IF NOT EXISTS is_verified      TINYINT(1)  NOT NULL DEFAULT 0;
ALTER TABLE assets ADD COLUMN IF NOT EXISTS criticality      VARCHAR(30) DEFAULT NULL;
ALTER TABLE assets ADD COLUMN IF NOT EXISTS rber             TINYINT(1)  NOT NULL DEFAULT 0;
ALTER TABLE assets ADD COLUMN IF NOT EXISTS condemned        TINYINT(1)  NOT NULL DEFAULT 0;
