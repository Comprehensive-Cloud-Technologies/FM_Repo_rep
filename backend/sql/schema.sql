...
CREATE TABLE IF NOT EXISTS assets (
	...
	calibration_frequency VARCHAR(40),
	last_calibration_date DATE,
	next_calibration_due_date DATE,
	calibration_status VARCHAR(30),
	calibration_vendor_id INT UNSIGNED,
	...
	KEY idx_assets_calibration_due (next_calibration_due_date),
	KEY idx_assets_calibration_vendor (calibration_vendor_id),
